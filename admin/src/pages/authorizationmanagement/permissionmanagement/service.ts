...
export async function updateOne(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>(`api/permission/${data?.permissionId}`, {
    data,
    method: 'POST',
    ...(options || {}),
  });
...
export async function addOne(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('api/permission', {
    data,
    method: 'POST',
    ...(options || {}),
  });
...
export async function removeMany(data: any, options?: any ) {
  return request<Record<string, any>>('api/permission', {
    data,
    method: 'DELETE',
    ...(options || {}),
  });
