...
const TableList: React.FC = () => {
  ...
  let tableColumn = [
    ...
    { 
      hidden: !permission_url?.includes('/employee/update_update'),
      title: 'Action',
      dataIndex: 'option',
      valueType: 'option',
      render: (_, record) => [
        <Button
          ...
          type="primary"
          onClick={() => {
            history.push('/category/employee/update/' + record.idnv);
          }}
        >
  ...
  return (
    <PageContainer>
      <ProTable<TableListItem, TableListPagination>
        ...
        toolBarRender={() => [
          <div key={1}>
            {permission_url?.includes('/employee/add_add') && (
              <Button
                type="primary"
                menu={menuProps}
                onClick={() => {
                  // handleCheckDupModalVisible(true)
                  history.push('/category/employee/add');
                }}
              >
          ...
          <div key={2}>
            {permission_url?.includes('/employee/delete_delete') && (
              <Popconfirm
                title="Delete"
