...
export async function getAlldeviceassignment(
  params: {
    // query
    /** Current page number */
    current?: number;
...
export async function updateOne(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>(`api/devicereturn/${data?.id}`, {
    data,
    method: 'POST',
    ...(options || {}),
  });
...
export async function addOne(data: { [key: string]: any }, options?: { [key: string]: any }) {
  return request<TableListItem>('api/devicereturn', {
    data,
    method: 'POST',
    ...(options || {}),
  });
...
export async function removeMany(data: any, options?: any) {
  return request<Record<string, any>>('api/devicereturn', {
    data,
    method: 'DELETE',
    ...(options || {}),
  });
...
export async function assignManyNutritional(
  data: { [key: string]: any },
  options?: { [key: string]: any },
) {
...
export async function getById(id: string): Promise<{ data: [] }> {
  return request(`api/devicereturn/${id}`);
}
